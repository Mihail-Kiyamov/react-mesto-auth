...
function Header({ isLoggedIn, onExit, isMobile, onMobileMenuClick, isMobileMenuOpen }) {
        ...
        <header className="header">
            ...
            {isLoggedIn && !isMobile &&
                <>
                    ...
                    <button className="header__account-exit" onClick={onExit} type="text">Выйти</button>
                </>}

            {isLoggedIn && isMobile &&
                <button className="header__mobile-menu" type="button" onClick={onMobileMenuClick} >
                    {isMobileMenuOpen 
